...
class MealsControllerTest < ActionController::TestCase
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post :create, meal: { calories: @meal.calories, date_id: @meal.date_id, description: @meal.description }
    end
  ...
  test "should update meal" do
    patch :update, id: @meal, meal: { calories: @meal.calories, date_id: @meal.date_id, description: @meal.description }
    assert_redirected_to meal_path(assigns(:meal))
  end
